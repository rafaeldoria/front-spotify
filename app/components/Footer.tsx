...
export function Footer() {
    return (
        ...
        <div className='flex items-center gap-3'>
          <Image src="/titas.jpg" width={56} height={56} alt="Image" />
          <div className='flex flex-col'>
            <strong className='font-normal'>Família</strong>
            <span className='text-xs text-zinc-400'>Titãs</span>
          </div>
        </div>
        ...
        <div className='flex flex-col items-center gap-2'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <span className='text-xs text-zinc-400'>4:07</span>
          </div>
